...
모든 드라마 캐릭터의 명대사를 인터넷에서 **수작업으로 모두 수집**하여 정확한 페르소나를 구현했습니다. 파인튜닝이나 임베딩 패턴 학습 없이, 오직 **프롬프트 기반 방식**으로 캐릭터의 스타일만 참고하는 구조로 설계되었습니다.
...
- **🎬 수작업으로 수집한 드라마 명대사 기반**: 
  - `personas.py`의 모든 캐릭터 데이터는 각 드라마의 **실제 명대사를 수작업으로 모두 수집**하여 작성되었습니다
  - 인터넷에서 각 드라마의 명대사를 하나하나 **수작업으로 수집**하여 캐릭터의 고유한 말투와 감성을 정확히 재현했습니다
...
│   ├── personas.py                   # 캐릭터 페르소나 데이터 (수작업으로 수집한 드라마 명대사 기반, 프롬프트 형식으로 구성)
