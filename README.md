...
드라마가 끝나도 아쉬웠던 그 순간들을 다시 살려보세요. 좋아하는 캐릭터와 깊이 있는 대화를 나누고, 손편지를 주고받으며, 함께 토론하고, 감정을 나눌 수 있습니다. 각 드라마의 명대사를 직접 수집하여 캐릭터의 고유한 말투와 성격을 정확히 재현했으며, 프롬프트 기반 방식으로 저작권 문제 없이 안전하게 구현했습니다.
...
- **🎬 직접 수집한 드라마 명대사 기반**: 
  - `personas.py`의 모든 캐릭터 데이터는 각 드라마의 **실제 명대사를 직접 수집**하여 작성되었습니다
...
│   ├── personas.py                   # 캐릭터 페르소나 데이터 (직접 수집한 드라마 명대사 기반, 프롬프트 형식으로 구성)
