...
- **드라마 명대사 활용**: `personas.py`의 캐릭터 데이터는 각 드라마의 실제 명대사를 기반으로 프롬프트 형식으로 구성되어 있어, 캐릭터의 고유한 말투와 감성을 정확히 재현합니다. 모든 드라마 명대사는 인터넷에서 직접 수집하여 작성한 것입니다
...
│   ├── personas.py                   # 캐릭터 페르소나 데이터 (드라마 명대사 기반, 프롬프트 형식)
