    ...
    useEffect(() => {
        const updateSettingsButtonPosition = () => {
            ...
            if (window.innerWidth <= 480) {
                ...
                // 토론 개입 "선택지 다시 보기" 버튼 위치 조정 (입력창 위에 배치 - 웹 버전과 동일한 방식)
